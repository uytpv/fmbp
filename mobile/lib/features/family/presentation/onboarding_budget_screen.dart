...
class OnboardingBudgetScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<OnboardingBudgetScreen> createState() => _OnboardingBudgetScreenState();
}

class _OnboardingBudgetScreenState extends ConsumerState<OnboardingBudgetScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final familyId = await ref.read(onboardingStateProvider.notifier).setupFamilyAndBudget(
            familyName: name,
      ...
      if (mounted) {
        context.go('/onboarding/members?familyId=$familyId');
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Có lỗi xảy ra khi tạo ngân sách: $e'),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: const [
                        ...
                        SizedBox(width: 8),
                        Text('Bước 1/2: Thiết Lập Ngân Sách Gia Đình', style: TextStyle(fontWeight: FontWeight.bold, color: AppColors.primary)),
                      ],
                    ),
                  ),
                  ...
                  Text(
                    'Lập kế hoạch quản lý bữa ăn & tài chính gia đình.',
                    textAlign: TextAlign.center,
                    style: theme.textTheme.bodyMedium?.copyWith(
                    ...
                    AppCard(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Column(
                            children: [
                              for (int idx = 0; idx < _fixedExpenses.length; idx++) ...[
                                if (idx > 0) const SizedBox(height: 8),
                                InkWell(
                                  onTap: () => _editExpenseDialog(_fixedExpenses[idx], idx),
                                  ...
                                  child: Container(
                                    ...
                                    child: Row(
                                      children: [
                                        Icon(
                                          _fixedExpenses[idx].category == 'housing'
                                              ? Icons.home_outlined
                                              : _fixedExpenses[idx].category == 'vehicle'
                                                  ? Icons.directions_car_outlined
                                                  : _fixedExpenses[idx].category == 'loan'
                                        ...
                                        Expanded(
                                          child: Column(
                                            crossAxisAlignment: CrossAxisAlignment.start,
                                            children: [
                                              Text(_fixedExpenses[idx].title, style: theme.textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w600)),
                                              if (_fixedExpenses[idx].termMonths != null)
                                                Text('Thời hạn: ${_fixedExpenses[idx].termMonths} tháng', style: theme.textTheme.bodySmall?.copyWith(color: theme.disabledColor)),
                                            ],
                                          ),
                                        ),
                                        Text(
                                          currencySvc.format(_fixedExpenses[idx].amount, _selectedCurrency),
                                          style: theme.textTheme.bodyMedium?.copyWith(
                                            fontWeight: FontWeight.bold,
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () => _editExpenseDialog(_fixedExpenses[idx], idx),
                                        ),
                                        IconButton(
                  ...
                  AppButton(
                    text: 'Lưu Ngân Sách & Khai Báo Nhân Khẩu (Bước 2/2) ➔',
